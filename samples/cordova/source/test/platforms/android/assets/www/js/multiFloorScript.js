...
function toggle_image(imageId)
{

    //alert("hello");
    var myImage = document.getElementById(imageId); // or whatever means of access
    var src = myImage.src;
    ...
    //alert(Filename);
    if(Filename == "light-bulb-icon.jpg" )
    {
      //alert("hellooooo");
     myImage.src='js/widgets/lightbulb/glossy-light-bulb.jpg';

    }

    if(Filename == "glossy-light-bulb.jpg" )
    {
      //alert("he");
      myImage.src='js/widgets/lightbulb/light-bulb-icon.jpg';
    }



    if(Filename == "semi-matte-light-bulb-unlit-th.png" )
    {
      //alert("hellooooo");
     myImage.src='js/widgets/lightbulb/semi-matte-light-bulb-lit-th.png';

    }

    if(Filename == "semi-matte-light-bulb-lit-th.png" )
    {
      //alert("he");
