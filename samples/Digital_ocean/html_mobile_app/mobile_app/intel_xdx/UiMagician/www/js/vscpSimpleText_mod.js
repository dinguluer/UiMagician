                                     ...
                                     )
{
    ...
    //alert("coding index = " + this.codingIndex);
...
//alert(parseInt(msgitems_comma[offset+i]));
                ...
                if ((VSCP_CLASS1_MEASUREMENT == this.vscpclass) ||
                    ...
                    var data = [{ time: get_time(), y: value }];
        ...
        if ((VSCP_CLASS1_MEASUREMENT == this.vscpclass) ||
            ...
            //alert("pass_1");
            //alert("coding indx rx = " + vscpws_getSensorIndexFromDataCoding(vscpdata[0]));
            if (( -1 != this.codingIndex) &&
