...
void GenerateApp::createHtmlHead()
{
    ...
    {
        htmlFile.setFileName(htmlFilePath);
    }
...
void GenerateApp::createFloorCfgFiles()
{
    ...
    {
        floorCfgFile.setFileName(floorCfgFilePath);
    }
    // open read & write mode
    ...
    {
        FloorsSocketCfgFile.setFileName(FloorsSocketCfgFilePath);
    }
    // open read & write mode
    ...
    {
        xmlVariablesFile.setFileName(xmlVariablesFilePath);
    }
    ...
    {
        xmlDmFile.setFileName(xmlDmFilePath);
    }
